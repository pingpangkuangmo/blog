...
如果去掉JspServlet，当你访问a.jsp文件的时候，可能会有DefaultServlet来处理，这时候就不会进行翻译工作，直接文件内容返回

#servlet的url-pattern的规则
对于servlet的url-pattern规则，这里已有一篇对应的源码分析文章[tomcat的url-pattern源码分析](http://www.cnblogs.com/fangjian0423/p/servletContainer-tomcat-urlPattern.html)，所以不再进行源码分析，只说明结论。
